...
class Message:
    ...
    # Deterministic analysis artifact (ToolResult dict) attached to this
    # assistant answer — lets follow-ups like "make this into a report
    # section" reuse the previous result without re-running anything.
