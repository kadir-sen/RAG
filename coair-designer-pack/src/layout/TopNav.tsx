...
export default function TopNav() {
  ...
  return (
    <header
      className="grid grid-cols-[1fr_auto_1fr] items-center px-4 border-b-2 border-[var(--ink)] flex-shrink-0 bg-[var(--bg-secondary)]"
    ...
    >
      ...
      <div className="flex items-center gap-2 justify-self-end text-[var(--text-secondary)]">
        ...
        <button
          ...
          className="w-8 h-8 flex items-center justify-center rounded-md hover:text-[var(--text-primary)] hover:bg-[var(--bg-hover)] transition-colors"
        >
