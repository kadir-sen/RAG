...
import { getIndexingStatus, getStats, getExportUrl, exportFilesCsvOffline } from '../../api/fileApi';
          ...
          <div className="flex-1 overflow-y-auto px-2 py-1">
            {docs.length === 0 ? (
              ...
              docs.map(doc => (
                ...
                >
                  <div
                    className="w-0.5 h-6 ml-1 flex-shrink-0"
              ...
              <div className="space-y-1">
                {indexing.data.map((s) => (
                  ...
                  >
                    ...
                    {s.status === 'indexing' && (
                      <div className="w-16 h-1 bg-[var(--wash-firm)] overflow-hidden">
                        <div
