...
export default function EngineeringInputBar({
  ...
  return (
    <div className="flex items-center gap-2 bg-[var(--bg-surface)] border border-[var(--border)] rounded-[2px] focus-within:border-[var(--ink)] transition-colors px-4 py-2.5">
