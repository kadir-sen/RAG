        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-5">
          {MODE_CARDS.map((m) => (
            <button
              ...
              className="group flex bg-[var(--wash)] border border-[var(--border)] hover:border-[var(--accent)] hover:bg-[var(--wash)] rounded-md overflow-hidden text-left transition-colors"
            >
              ...
              <div className="flex-1 p-5">
                ...
                <h2 className="text-base md:text-lg font-semibold text-[var(--text-primary)] mt-3">{m.title}</h2>
