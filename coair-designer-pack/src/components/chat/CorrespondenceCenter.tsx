      ...
      <div className="flex-1 overflow-y-auto px-6 md:px-10 py-6 md:py-8">
        <div className="max-w-4xl mx-auto flex flex-col gap-5 animate-fade-in-up">
          ...
          <div>
            ...
            <h2 className="text-xl md:text-2xl font-semibold text-[var(--text-primary)] tracking-tight mt-1">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="min-w-0">
                        <p className="text-[12px] md:text-sm text-[var(--text-primary)] font-medium truncate">
                ...
                <button
                  ...
                  className={`text-xs font-mono tracking-wide px-3 py-1.5 rounded transition-colors disabled:opacity-40 disabled:cursor-not-allowed ${
                    a.tone === 'primary'
                      ...
                      : 'border border-[var(--border)] hover:border-[var(--accent)] text-[var(--text-secondary)] hover:text-[var(--text-primary)]'
                  }`}
                >
