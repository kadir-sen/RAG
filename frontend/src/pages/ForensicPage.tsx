  ...
  return (
    <div className="flex-1 min-w-0 overflow-y-auto">
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 py-8">
        <Link to="/" className="font-mono text-[10px] uppercase tracking-[.18em] text-[var(--text-muted)]">← modules</Link>
        <h1 className="mt-5 text-xl font-semibold text-[var(--text-primary)]">Forensic Reports</h1>
