    ...
    >
      ...
      <nav aria-label="Main navigation" className="flex items-center justify-self-start">
        <button
          ...
          className="w-8 h-8 flex items-center justify-center rounded-md text-[var(--text-secondary)] hover:text-white hover:bg-[var(--bg-hover)] transition-colors"
        >
          {sidebarOpen ? (
      ...
      <div className="flex items-center gap-2 justify-self-end text-[var(--text-secondary)]">
        ...
        <button
          ...
          className="w-8 h-8 flex items-center justify-center rounded-md hover:text-white hover:bg-[var(--bg-hover)] transition-colors"
        >
