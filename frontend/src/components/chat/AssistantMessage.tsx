...
function AssistantMessage({ response, text, onDocClick, failedText, onRetry }: Props) {
  ...
  return (
    <div className="flex justify-start mb-5 gap-3 px-4 animate-fade-in-up group">
      {/* AI Avatar */}
      <div className="flex-shrink-0 w-7 h-7 md:w-8 md:h-8 rounded-full bg-[var(--accent)] flex items-center justify-center mt-1" aria-hidden="true">
      ...
      <div className="max-w-4xl min-w-0">
        ...
        {/* Main content card */}
        <div className="px-4 py-4 md:px-6 md:py-5 rounded-2xl rounded-tl-sm bg-[var(--bg-surface)] text-sm leading-relaxed shadow-sm">
